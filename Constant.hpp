...
int const REFRACT_TIME(3.0);                    //time during which the neuron stays inactive after a spike       
...
double const DELAY(15);                        //delay after wich the post synaptic neuron responds to the presynaptic signal  
